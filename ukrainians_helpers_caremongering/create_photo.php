...
<!--end post comments notifications-->
 ...
 <li class="navgate_no"><a title='Add Photos' data-toggle='modal' data-target='#myModal_emp' style="color:white;font-size:14px;">
...
<center><h3>Upload/Add Photos</h3></center>
...
<i  style="color:white;font-size:20px;" class="fa fa-camera" aria-hidden="true"></i> Add Photos</button></center><br>
...
<option value="Gloceries-Delivery">Gloceries Delivery</option>
...
<option value="IT-Learning">IT-Learning</option>
...
<div class="col-sm-12 form-group">
<label style="padding:6px;color:white;background:#ec5574;text-align:left;font-size:16px;">Select  Photo: </label>
...
<div class="col-sm-12 form-group">
<label>Full Location Address with City and Country Name Eg: <span style='color:green;'>(19 km of Zhytomyr highway 3179, Kiev city, Ukraine )</span></label><br>
...
<button type="button" id="save_btn" class="category_post"  /> Upload Photo</button>
</div>
...
//$url ="$tg_url:9000/graph/$graph_db/vertices/$table_posts?sort=-timer&'filter=data_type=photo'";
...
//$emx = htmlentities(htmlentities($row["attributes"]["email"], ENT_QUOTES, "UTF-8"));
...
if($data_type  == 'photo'){
?>
<img class='responsive_video' width='500' height='300' src='uploads/<?php echo $photo; ?>'>
<br><br>
<?php } ?>
