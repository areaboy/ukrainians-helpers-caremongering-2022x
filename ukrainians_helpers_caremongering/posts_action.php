...
if($output ==''){
echo "<div style='background:red;color:white;padding:8px;border:none;'>Connection to Tgergraph Database Failed. Ensure there is Internet Connection and Try Again</div>";
exit();
}
...
echo "<script>alert('Post Submission Successful');
...
echo "<div style='background:green;color:white;padding:8px;border:none;'>Post Submission failed</div>";
