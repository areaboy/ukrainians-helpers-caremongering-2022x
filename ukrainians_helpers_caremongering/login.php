...
<form id="" method="post">
 <div class="form-group">
              <label style="background:#800000;color:white;text-align:left;font-size:16px;" for="email">
...
<br>
 <div class="form-group">
              <label style="background:#800000;color:white;text-align:left;font-size:16px;" for="psw">
